...
void _handleTaskStateChange(Task task) {
  setState(() {
    ...
    // Then filter based on mode and task state
    if (widget.mode == ListMode.upcoming) {
      // Remove if task is completed or no longer upcoming
      widget.tasks.removeWhere((t) => 
        t.isCompleted || !_isUpcoming(t) || t.id == task.id
      );
    }
  });
}
                                    ...
                                    setState(() {
                                      ...
                                      switch (widget.mode) {
                                        case ListMode.overdue:
                                          // Remove completed tasks and non-overdue tasks
                                          widget.tasks.removeWhere((t) => t.isCompleted || !_isOverdue(t));
                                          break;
                                        case ListMode.today:
                                          // Remove completed tasks and non-today tasks
                                          widget.tasks.removeWhere((t) => t.isCompleted || !_isToday(t));
                                          break;
                                        case ListMode.upcoming:
                                          // Remove completed tasks and non-upcoming tasks
                                          widget.tasks.removeWhere((t) => t.isCompleted || !_isUpcoming(t));
                                          break;
                                        case ListMode.completed:
                                          // Only show completed tasks
                                          widget.tasks.removeWhere((t) => !t.isCompleted);
                                          break;
                                        case ListMode.all:
                                          // Remove completed tasks from all view
                                          widget.tasks.removeWhere((t) => t.isCompleted);
                                          break;
                                      }
                                    });
  ...
  onPressed: (context) {
    ...
    widget.onTaskCompleted(completedTask);
    _handleTaskStateChange(completedTask);
  },
